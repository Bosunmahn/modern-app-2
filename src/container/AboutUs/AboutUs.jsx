    ...
    <div className="app__aboutus-content flex__center">
      <div className="app__aboutus-content_about ">
        ...
        <p className="p__opensans">
          About Us Our History Lorem ipsum dolor sit amet, consectetur
          adipiscing elit. Quis pharetra adipiscing ultrices vulputate posuere
          tristique. In sed odio nec aliquet eu proin mauris et. Adipiscing
          tempus ullamcorper lobortis odio tellus arcu volutpat. Risus placerat
